function selffunction() {
  ...
  // Object containing horoscope information and corresponding image sources
  var horo = {
    Aries: {
  ...
  // Check if a valid zodiac sign is selected
  if (hs in horo) {
    var result = horo[hs].text;
    var imgSrc = horo[hs].image;

    document.getElementById("textrow1").innerHTML = "What Your Horoscope Says About You:";
    document.getElementById("textrow2").innerHTML = result;

    var img_horo = document.getElementById("img_horo");
    img_horo.innerHTML = ""; // Clear previous content

    var img = document.createElement("img");
    img.src = imgSrc;
    img.alt = hs; // Alt attribute for accessibility
    img_horo.appendChild(img);
  } else {
    // Handle case where no zodiac sign is selected
    document.getElementById("textrow1").innerHTML = "";
    document.getElementById("textrow2").innerHTML = "Please select your Zodiac Sign.";
    var img_horo = document.getElementById("img_horo");
    img_horo.innerHTML = ""; // Clear previous content
  }
}
